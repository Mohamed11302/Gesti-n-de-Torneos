Public Class AgenteBD
    ...
    'Private Const cadenaConexion As String = "server=localhost;database=tenis;uid=root;pwd=0102030405En"
    'Private Const cadenaConexion As String = "server=localhost;database=tenis;uid=root;pwd=yoliyolan3" '
    Private Const cadenaConexion As String = "server=localhost;database=tenis;uid=root;pwd=mo6277"
    Private Sub New()
